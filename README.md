...
![Interface English](screen_shot/en.png)
...
- **15-Step Ultra-Fast Inference**: 
  Leverages Logit-Normal sampling and optimized Temporal Score Rescaling (TSR) to achieve high-quality audio in just **15 Euler steps**.
...
![インターフェース 日本語](screen_shot/jp.png)
...
- **15ステップ爆速推論**: 
  Logit-Normal サンプリングと最適化された TSR により、わずか **15ステップ** で高品質な音声を生成可能（標準の 40 ステップから大幅短縮）。
